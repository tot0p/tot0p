...
[![Duck](https://random-d.uk/api/285.jpg)](https://github.com/tot0p/tot0p/issues/new?title=%F0%9F%A6%86%20Quack)
<!--/DUCK-->

[Change the duck](https://github.com/tot0p/tot0p/issues/new?title=%F0%9F%A6%86%20Quack)

Click the link above to submit an issue to change the duck.

> :warning: The duck will only be changed if the issue title is `🦆 Quack` :warning:
